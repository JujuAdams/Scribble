...
var _sdf     = scribble("[scale,2][spr_sdf_industrydemi]" + _string);

_standard.wrap(500).sdf_feather(1.5).draw(10, 10);
_sdf.wrap(500).sdf_feather(1.5).draw(10, _standard.get_bbox(10, 10).bottom + 10);
