...
var _demo_string  = "[rainbow]abcdef[] ABCDEF[test event]##";
    ...
    _demo_string += "[fnt_test_0][fa_right]THE [fnt_test_1][#ff4499][shake]QUICK[fnt_test_0] [$D2691E]BROWN [$FF4499]FOX [fa_left]JUMPS OVER[$FFFF00] THE [/shake]LAZY [fnt_test_1]DOG.[test event][test event] [test event]";
