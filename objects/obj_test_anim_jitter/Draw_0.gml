...
_element.animation_blink(0.4, 1.2, 0.4).draw(_x, _y);
_y += _element.get_height() + 10;

var _element = scribble("[jitter]larger max scale", 2);
_element.animation_blink(0.8, 1.6, 0.4).draw(_x, _y);
_y += _element.get_height() + 10;

var _element = scribble("[jitter]higher speed", 3);
_element.animation_blink(0.8, 1.2, 0.55).draw(_x, _y);
_y += _element.get_height() + 10;

var _element = scribble("[jitter]larger min scale, smaller max scale, lower speed", 4);
_element.animation_blink(0.9, 1.1, 0.1).draw(_x, _y);
_y += _element.get_height() + 10;