...
draw_text(10,  70, "glyph grids cached = " + string(array_length(__scribble_get_cache_state().__gc_grid_refs)) + "/" + string(array_length(__scribble_get_cache_state().__gc_grid_ids)));
