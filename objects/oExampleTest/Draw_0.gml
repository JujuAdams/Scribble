...
//draw_set_font(-1);
//scribble_draw_from(test_text, 10, 30);

var _string  = "[c_xanadu][fTestB][sound,sndCrank][rainbow][thick,0.5]T[thick,0.33]E[thick,0.16]S[/thick]T[] [wobble]ABCDEF[/wobble]##";
