...
var _string  = "[sound,sndCrank][rainbow]TEST[] ABCDEF##";
    _string += "[wave][c_orange]0123456789[] .,<>\"'&[c_white][][rumble][rainbow]!?[]\n";
    _string += "\n";
    _string += "the quick brown fox jumps over the lazy dog";
    _string += "[fa_right]THE [$FF4499][rumble]QUICK [$D2691E]BROWN [$FF4499]FOX [fa_left]JUMPS OVER[$FFFF00] THE [/rumble]LAZY DOG.";
