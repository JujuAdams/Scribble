var _demo_string  = "Here's some text with [cycle,40,90,150,190]custom colour[/cycle] cycling!\n";
    ...
    _demo_string += "[cycle,40,90,150,190][spr_white_coin,0][spr_white_coin,1][spr_white_coin,2][spr_white_coin,0,0.1][spr_white_coin,1,0.1][spr_white_coin,2,0.1][spr_white_coin,1,0.1][/cycle]";
