...
var _demo_string  = "[snd_crank][rainbow][pulse]abcdef[/] ABCDEF##";
    _demo_string += "[wave][c_orange]0123456789[/] .,<>\"'&[c_white][spr_coin,0][snd_switch][spr_coin,1][snd_switch][spr_coin,2][snd_switch][spr_coin,3][snd_switch][/][shake][rainbow]!?[/]\n";
