...
|`SCRIBBLE_ALLOW_LINE_DATA_GETTER`       |`false`           |Set to `true` to enable the `.get_line_data()` method on text elements. This will apply to all text elements and carries a performance penalty                                              |
