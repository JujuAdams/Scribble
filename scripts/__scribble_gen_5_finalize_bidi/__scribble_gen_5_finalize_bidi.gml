...
function __scribble_gen_5_finalize_bidi()
{
    ...
    repeat(_word_count)
    {
        ...
        if (_bidi <= __SCRIBBLE_BIDI_SYMBOL) //symbol or whitespace
        {
            ...
            var _prev_bidi = (_i > 0)?             _word_grid[# _i-1, __SCRIBBLE_GEN_WORD.__BIDI] : __SCRIBBLE_BIDI_SYMBOL;
            var _next_bidi = (_i < _word_count-1)? _word_grid[# _i+1, __SCRIBBLE_GEN_WORD.__BIDI] : __SCRIBBLE_BIDI_SYMBOL;
