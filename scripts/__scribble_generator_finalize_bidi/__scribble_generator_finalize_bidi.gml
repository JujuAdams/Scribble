function __scribble_generator_finalize_bidi()
{
    ...
    repeat(_word_count)
    {
        ...
        if ((_bidi == __SCRIBBLE_BIDI.NEUTRAL) || (_bidi == __SCRIBBLE_BIDI.WHITESPACE))
        {
            ...
            var _next_bidi = (_i < _word_count-1)? _word_grid[# _i+1, __SCRIBBLE_PARSER_WORD.BIDI] : __SCRIBBLE_BIDI.NEUTRAL;
            ...
            if ((_prev_bidi == __SCRIBBLE_BIDI.NEUTRAL) || (_prev_bidi == __SCRIBBLE_BIDI.WHITESPACE)) _prev_bidi = _next_bidi;
            if ((_next_bidi == __SCRIBBLE_BIDI.NEUTRAL) || (_next_bidi == __SCRIBBLE_BIDI.WHITESPACE)) _next_bidi = _prev_bidi;
            ...
            if ((_new_bidi == __SCRIBBLE_BIDI.NEUTRAL) || (_new_bidi == __SCRIBBLE_BIDI.WHITESPACE)) _new_bidi = __SCRIBBLE_BIDI.L2R;
