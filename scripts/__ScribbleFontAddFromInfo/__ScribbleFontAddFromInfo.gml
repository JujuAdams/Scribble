...
function __ScribbleFontAddFromInfo(_name, _textureGroup, _textureUVs, _fontInfo, _lineHeight, _isKrutidev, _fromBundle)
{
    ...
    ds_grid_set_region(_fontGlyphDataGrid, 0, __SCRIBBLE_GLYPH_PROPR_FONT_HEIGHT,  _size-1, __SCRIBBLE_GLYPH_PROPR_FONT_HEIGHT,   _lineHeight + _sdfHeightOffset);
    ...
    repeat(_size)
    {
        ...
        //_fontGlyphDataGrid[# _i, __SCRIBBLE_GLYPH_PROPR_FONT_HEIGHT ] = _lineHeight + _sdfHeightOffset; //Set above in bulk
