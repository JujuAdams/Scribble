...
function __scribble_font_add_from_file(_filename, _point_size, _bold, _italic, _first, _last) 
{
    ...
    if (SCRIBBLE_VERBOSE) __scribble_trace("Adding \"", _filename, "\" as a font_add() font");
    ...
    try
    {
        ...
        var _font_data = new __scribble_class_font(_filename, _size, false);
        ...
        ds_grid_set_region(_font_glyph_data_grid, 0, SCRIBBLE_GLYPH.SDF_PXRANGE,            _size-1, SCRIBBLE_GLYPH.SDF_PXRANGE,            undefined                  );
        ds_grid_set_region(_font_glyph_data_grid, 0, SCRIBBLE_GLYPH.SDF_THICKNESS_OFFSET,   _size-1, SCRIBBLE_GLYPH.SDF_THICKNESS_OFFSET,   undefined                  );
        ds_grid_set_region(_font_glyph_data_grid, 0, SCRIBBLE_GLYPH.BILINEAR ,              _size-1, SCRIBBLE_GLYPH.BILINEAR,               undefined                  );
