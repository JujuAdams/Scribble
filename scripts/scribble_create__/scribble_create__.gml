...
var _text_colour           = $FF000000 + _def_colour;
...
for(var _i = 0; _i < _separator_count; _i++)
{
    ...
    var _buffer_word_offset = buffer_tell(_buffer);
        ...
        else
        {
            ...
            switch(_parameters_list[| 0 ])
            {
                ...
                case "":
                    ...
                    _text_colour      = $FF000000 + _def_colour;
                ...
                default:
                    ...
                    if (!_found)
                    {
                        ...
                        if (_asset >= 0) && (asset_get_type(_parameters_list[| 0]) == asset_sprite)
                        {
                            ...
                            #region Add the sprite to the buffer
                            
                            _previous_font = "";
                            
                            var _colour = SCRIBBLE_COLOURISE_SPRITES? _text_colour : $FFFFFFFF;
                            if ((_substr_image_speed > 0) && SCRIBBLE_FORCE_NO_SPRITE_ANIMATION)
                            {
                                _substr_image_speed = 0;
                                _colour = $FFFFFFFF;
                            }
                            ...
                            var _flags  = 0;
                            if (_substr_image_speed > 0) _flags += 1; //Set the "is sprite" flag only if we're animating the sprite
                            var _offset = 2;
                            
                            for(var _i = 1; _i < SCRIBBLE_MAX_FLAGS; _i++)
                            {
                                _flags += _text_flags[_i] * _offset;
                                _offset *= 2;
                            }
                            
                            //Default to only adding one image from the sprite to the vertex buffer
                            var _image_a = _substr_image;
                            var _image_b = _substr_image;
                            
                            //If we want to animate the sprite, add all images from the sprite
                            if (_substr_image_speed > 0)
                            {
                                _image_a = 0;
                            ...
                            for(var _image = _image_a; _image <= _image_b; _image++)
                            {
                                if (_substr_image_speed > 0)
                                {
                                    ...
                                    _colour = make_colour_rgb(_image, sprite_get_number(_sprite)-1, _substr_image_speed*255) + $FF000000;
                                    //Encode the starting image into the alpha channel
                                    var _alpha = _substr_image/255;
                                }
                                else
                                {
                                    var _alpha = 1;
                                ...
                                if (_sprite_texture != _previous_texture)
                                {
                                    ...
                                    {
                                        var _buffer = buffer_create(6*__SCRIBBLE_VERTEX_BYTE_SIZE, buffer_grow, 1);
                                ...
                                var _glyph_l = _text_x  + _uvs[4] + sprite_get_xoffset(_sprite);
                                var _glyph_t = _text_y  + _uvs[5] + sprite_get_yoffset(_sprite);
                                var _glyph_r = _glyph_l + _uvs[6]*_text_scale*sprite_get_width(_sprite);
                                var _glyph_b = _glyph_t + _uvs[7]*_text_scale*sprite_get_height(_sprite);
                                
                                buffer_write(_buffer, buffer_f32, _glyph_l); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[0]); buffer_write(_buffer, buffer_f32, _uvs[1]);
                                buffer_write(_buffer, buffer_f32, _glyph_l); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[0]); buffer_write(_buffer, buffer_f32, _uvs[3]);
                                buffer_write(_buffer, buffer_f32, _glyph_r); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[2]); buffer_write(_buffer, buffer_f32, _uvs[3]);
                                buffer_write(_buffer, buffer_f32, _glyph_r); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[2]); buffer_write(_buffer, buffer_f32, _uvs[3]);
                                buffer_write(_buffer, buffer_f32, _glyph_r); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[2]); buffer_write(_buffer, buffer_f32, _uvs[1]);
                                buffer_write(_buffer, buffer_f32, _glyph_l); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _uvs[0]); buffer_write(_buffer, buffer_f32, _uvs[1]);
                                
                                //vertex_position_3d(_vbuff,   _glyph_l, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[0], _uvs[1]);
                                //vertex_position_3d(_vbuff,   _glyph_l, _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[0], _uvs[3]);
                                //vertex_position_3d(_vbuff,   _glyph_r, _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[2], _uvs[3]);
                                //vertex_position_3d(_vbuff,   _glyph_r, _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[2], _uvs[3]);
                                //vertex_position_3d(_vbuff,   _glyph_r, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[2], _uvs[1]);
                                //vertex_position_3d(_vbuff,   _glyph_l, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   0, 0, _flags); vertex_colour(_vbuff,   _colour, _alpha); vertex_texcoord(_vbuff,   _uvs[0], _uvs[1]);
                            }
    ...
    else
    {
        ...
        if (_text_font != _previous_font)
        {
            ...
            if (_font_texture != _previous_texture)
            {
                ...
                if (_vbuff_data == undefined)
                {
                    var _buffer = buffer_create(100*6*__SCRIBBLE_VERTEX_BYTE_SIZE, buffer_grow, 1);
        ...
        repeat(_substr_length)
        {
            if (_font_glyphs_array == undefined)
            {
                var _array = _font_glyphs_map[? string_char_at(_substr, _char_index)];
            ...
            buffer_write(_buffer, buffer_f32, _glyph_l+_slant_offset); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u0); buffer_write(_buffer, buffer_f32, _glyph_v0);
            buffer_write(_buffer, buffer_f32, _glyph_l              ); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u0); buffer_write(_buffer, buffer_f32, _glyph_v1);
            buffer_write(_buffer, buffer_f32, _glyph_r              ); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u1); buffer_write(_buffer, buffer_f32, _glyph_v1);
            buffer_write(_buffer, buffer_f32, _glyph_r              ); buffer_write(_buffer, buffer_f32, _glyph_b); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u1); buffer_write(_buffer, buffer_f32, _glyph_v1);
            buffer_write(_buffer, buffer_f32, _glyph_r+_slant_offset); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u1); buffer_write(_buffer, buffer_f32, _glyph_v0);
            buffer_write(_buffer, buffer_f32, _glyph_l+_slant_offset); buffer_write(_buffer, buffer_f32, _glyph_t); buffer_write(_buffer, buffer_f32, SCRIBBLE_Z);    buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, 0); buffer_write(_buffer, buffer_f32, _flags);    buffer_write(_buffer, buffer_u32, _text_colour);    buffer_write(_buffer, buffer_f32, _glyph_u0); buffer_write(_buffer, buffer_f32, _glyph_v0);
            
            //vertex_position_3d(_vbuff,   _glyph_l+_slant_offset, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u0, _glyph_v0);
            //vertex_position_3d(_vbuff,   _glyph_l              , _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u0, _glyph_v1);
            //vertex_position_3d(_vbuff,   _glyph_r              , _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u1, _glyph_v1);
            //vertex_position_3d(_vbuff,   _glyph_r              , _glyph_b, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u1, _glyph_v1);
            //vertex_position_3d(_vbuff,   _glyph_r+_slant_offset, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u1, _glyph_v0);
            //vertex_position_3d(_vbuff,   _glyph_l+_slant_offset, _glyph_t, SCRIBBLE_Z); vertex_normal(_vbuff,   _char_pc, _line_pc, _flags); vertex_colour(_vbuff,   _text_colour, 1); vertex_texcoord(_vbuff,   _glyph_u0, _glyph_v0);
...
for(var _i = 0; _i < _size; _i++)
{
    ...
    var _vertex_count = _tell / __SCRIBBLE_VERTEX_BYTE_SIZE;
...
//if (SCRIBBLE_VERBOSE) show_debug_message("Scribble: Expected glyph count=" + string(string_length(_str)) + ", expected buffer size=" + string(6*string_length(_str)*__SCRIBBLE_VERTEX_BYTE_SIZE) + " bytes");
//_buffer = buffer_create(6*string_length(_str)*__SCRIBBLE_VERTEX_BYTE_SIZE, buffer_grow, 1);
//
//var _t1 = get_timer();
//repeat(6*string_length(_str))
//{
//    buffer_write(_buffer, buffer_f32, random(1)); buffer_write(_buffer, buffer_f32, random(1)); buffer_write(_buffer, buffer_f32, random(1)); //xyz
//    buffer_write(_buffer, buffer_f32, random(1)); buffer_write(_buffer, buffer_f32, random(1)); buffer_write(_buffer, buffer_f32, random(1)); //normal
//    buffer_write(_buffer, buffer_u32, irandom($FFFFFFFF)); //colour
//    buffer_write(_buffer, buffer_f32, random(1)); buffer_write(_buffer, buffer_f32, random(1)); //texture
//}
//
//var _t2 = get_timer();
//var _vbuff = vertex_create_buffer_from_buffer_ext(_buffer, global.__scribble_vertex_format, 0, 6*string_length(_str));
//show_debug_message("t1=" + string(get_timer() - _t1));
//show_debug_message("t2=" + string(get_timer() - _t2));
//buffer_delete(_buffer);
//
//show_message("!");
        ...
        if (_sprite != noone)
        {
            ...
            for(var _image = _image_a; _image <= _image_b; _image++)
            {
                ...
                if (_sprite_texture != _previous_texture)
                {
                    ...
                    if (_vbuff_data == undefined)
                    {
                        var _buffer = buffer_create(__SCRIBBLE_VERTEX_BYTE_SIZE, buffer_grow, 1);
