...
#macro __SCRIBBLE_GEN_WORD_END  _word_glyph_end = _i-1;\
                                ...
                                {\
                                    ...
                                    ds_grid_set_region(_glyph_grid, _word_glyph_start, __SCRIBBLE_GEN_GLYPH_ANIMATION_INDEX, _word_glyph_end, __SCRIBBLE_GEN_GLYPH_ANIMATION_INDEX, _word_glyph_start);\
...
function __scribble_gen_4_build_words()
{
    ...
    if (_glyph_count > 0)
    {
        ...
        {
            _word_width -= _glyph_grid[# 0, __SCRIBBLE_GEN_GLYPH_SEPARATION];
            _glyph_grid[# 0, __SCRIBBLE_GEN_GLYPH_X] += _word_width;
        }
        ...
        repeat(_glyph_count-1) //Ensure we fully handle the last word by including the null terminator in this loop
        {
                ...
                case __SCRIBBLE_BIDI_R2L_ARABIC:
                    ...
                    else if (_word_bidi == __SCRIBBLE_BIDI_SYMBOL) // If the current word has a neutral direction, inherit the direction of the next L2R or R2L glyph
                    {
                        ...
                        if (_word_bidi >= __SCRIBBLE_BIDI_R2L)
                        {
                            ...
                            repeat(_i - _j)
                            {
                                _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_X] += _word_width;
                                _word_width -= _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_SEPARATION];
                                _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_X] += _word_width;
                                ++_j;
                            }
                        }
            ...
            else // __SCRIBBLE_BIDI_R2L or __SCRIBBLE_BIDI_R2L_ARABIC
            {
                ...
                if (_word_bidi == __SCRIBBLE_BIDI_R2L) _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_ANIMATION_INDEX] = _i;
            }
