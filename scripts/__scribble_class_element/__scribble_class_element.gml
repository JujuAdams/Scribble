...
function __scribble_class_element(_string, _unique_id = "") constructor
{
    ...
    static __update_bbox_matrix = function()
    {
        ...
        if (__bbox_dirty)
        {
            ...
            var _page = SCRIBBLE_BOUNDING_BOX_USES_PAGE? __scroll_page : undefined;
            var _bbox = _model.__get_bbox(_page, __padding_l, __padding_t, __padding_r, __padding_b);
            _bbox.top    -= get_page_y(_page);
            _bbox.bottom -= get_page_y(_page);
    ...
    static __set_standard_uniforms = function(_typist, _function_scope)
    {
        ...
        else if (__tw_reveal != undefined)
        {
            ...
            shader_set_uniform_i(_u_iTypistCharMax,           0);
            ...
            shader_set_uniform_f_array(_u_fTypistWindowArray, __tw_reveal_window_array);
        }
        else
        {
