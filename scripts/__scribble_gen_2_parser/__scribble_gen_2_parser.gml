#macro __SCRIBBLE_PARSER_PUSH_SCALE  if (_state_scale != 1)\
                                     {\
                                            ds_grid_multiply_region(_glyph_grid, _state_scale_start_glyph, __SCRIBBLE_GEN_GLYPH.__X, _glyph_count, __SCRIBBLE_GEN_GLYPH.__LEFT_OFFSET, _state_scale);\ //Covers many properties all at the same time
                                     }\
...
#macro __SCRIBBLE_PARSER_WRITE_GLYPH  ;\//Pull info out of the font's data structures
                                      ...
                                      {\
                                          ...
                                          ds_grid_set_grid_region(_glyph_grid, _font_glyph_data_grid, _data_index, __SCRIBBLE_GLYPH.__UNICODE, _data_index, __SCRIBBLE_GLYPH.__V1, _glyph_count, __SCRIBBLE_GEN_GLYPH.__UNICODE);\
                                          _glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__CONTROL_COUNT] = _control_count;\
...
function __scribble_gen_2_parser()
{
    ...
    var _command_tag_behaviour = _element.__command_tag_behaviour;
    ...
    if ((_overall_bidi != __SCRIBBLE_BIDI.L2R) && (_overall_bidi != __SCRIBBLE_BIDI.R2L))
    {
        ...
        repeat(string_byte_length(_element_text))
        {
            ...
            if ((_glyph_ord == SCRIBBLE_COMMAND_TAG_OPEN) && (_command_tag_behaviour == __SCRIBBLE_COMMAND_TAG.IGNORE))
            {
    ...
    while(true)
    {
        ...
        if (_tag_start != undefined)
        {
            ...
            {
                if (_command_tag_behaviour == __SCRIBBLE_COMMAND_TAG.HIDE)
                {
                ...
                else
                {
                    ...
                    switch(_command_tag_lookup_accelerator_map[? _tag_command_name])
                    {
                        ...
                        case 28:
                            ...
                            _glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__MATERIAL     ] = surface_get_texture(_surface);
                        ...
                        default: //TODO - Optimize
                            ...
                            else if (variable_struct_exists(_colours_struct, _tag_command_name)) //Set a pre-defined colour
                            {
                                _state_colour = (_state_colour & 0xFF000000) | (_colours_struct[$ _tag_command_name] & 0x00FFFFFF);
        ...
        {
            if ((_glyph_ord == SCRIBBLE_COMMAND_TAG_OPEN) && (_command_tag_behaviour != __SCRIBBLE_COMMAND_TAG.IGNORE) && (_state_command_tag_flipflop || (__scribble_buffer_peek_unicode(_string_buffer, buffer_tell(_string_buffer)) != SCRIBBLE_COMMAND_TAG_OPEN)))
            {
