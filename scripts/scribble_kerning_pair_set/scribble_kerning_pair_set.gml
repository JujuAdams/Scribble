...
/// @param secondChar         Second character in the pair, as a string, or a range of characters
...
function scribble_kerning_pair_set(_font, _first_char, _glyph_range, _value, _relative = false)
{
    ...
    {
        var _second_unicode = _glyph_array[_i];
    ...
    return (array_length(_glyph_array) == 1)? _new_value : undefined;
}