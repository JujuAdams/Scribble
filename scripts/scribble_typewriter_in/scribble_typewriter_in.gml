...
_json[| SCRIBBLE.TW_DIRECTION] = 1;
_json[| SCRIBBLE.TW_POSITION ] = 0;

if (_speed      != undefined) _json[| SCRIBBLE.TW_SPEED     ] = _speed;
if (_method     != undefined) _json[| SCRIBBLE.TW_METHOD    ] = _method;
if (_smoothness != undefined) _json[| SCRIBBLE.TW_SMOOTHNESS] = _smoothness;
...
switch(_json[| SCRIBBLE.TW_METHOD])
{
    ...
    case SCRIBBLE_TYPEWRITER_PER_CHARACTER:
        _json[| SCRIBBLE.CHAR_FADE_T] = 0;
        _json[| SCRIBBLE.LINE_FADE_T] = 1;
    break;
    
    case SCRIBBLE_TYPEWRITER_PER_LINE:
        _json[| SCRIBBLE.CHAR_FADE_T] = 1;
        _json[| SCRIBBLE.LINE_FADE_T] = 0;
    break;
