...
/** @desc Returns a Scribble text element corresponding to the input string
...
/// @param {string|real} [uniqueID]   A unique identifier that can be used to distinguish this occurrence of the input string from other occurrences. Only necessary when you might be drawing the same string at the same time with different animation states
