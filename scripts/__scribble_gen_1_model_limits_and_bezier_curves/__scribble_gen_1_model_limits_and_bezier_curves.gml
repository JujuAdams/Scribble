function __scribble_gen_1_model_limits_and_bezier_curves()
{
    ...
    var _model_max_height = ((_element.__layout_type == __SCRIBBLE_LAYOUT.__SCROLLABLE)? infinity : _element.__layout_height) - (_element.__padding_t + _element.__padding_b);
