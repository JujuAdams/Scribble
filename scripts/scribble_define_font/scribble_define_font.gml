...
/// @param [path]     File path for the font's .yy file, including the .yy extension, relative to the font directory defined by scribble_start()
///                   If not specified, Scribble will look in the root of the font directory

if ( !variable_global_exists("__scribble_global_count") )
{
    show_error("Scribble:\nscribble_init_add_font() should be called after scribble_start()\n ", true);
    return undefined;
}
