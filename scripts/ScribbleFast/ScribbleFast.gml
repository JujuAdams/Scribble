...
function ScribbleFast(_x, _y, _string, _colour = c_white, _alpha = 1, _hAlign = fa_left, _vAlign = fa_top, _font = undefined, _preScale = 1, _maxWidth = infinity, _maxHeight = infinity, _scaleToBox = false)
{
