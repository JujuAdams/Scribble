// Feather disable all
#macro __SCRIBBLE_PARSER_INSERT_NUKTA  ds_grid_set_grid_region(_temp_grid, _glyph_grid, _i+1, 0, _glyphCount+3, __SCRIBBLE_GEN_GLYPH_SIZE, 0, 0);\
                                       ds_grid_set_grid_region(_glyph_grid, _temp_grid, 0, 0, _glyphCount+3 - _i, __SCRIBBLE_GEN_GLYPH_SIZE, _i+2, 0);\
                                       \
                                       ++_i;\
                                       ++_glyphCount;\
                                       \
                                       _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = 0x093C;\ //Nukta
                                       _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
...
function __scribble_gen_3_devanagari()
{
    ...
    _glyph_grid[# _glyphCount,   __SCRIBBLE_GEN_GLYPH_UNICODE] = 0xFFFF;
    _glyph_grid[# _glyphCount+1, __SCRIBBLE_GEN_GLYPH_UNICODE] = 0xFFFF;
    _glyph_grid[# _glyphCount+2, __SCRIBBLE_GEN_GLYPH_UNICODE] = 0xFFFF;
    _glyph_grid[# _glyphCount+3, __SCRIBBLE_GEN_GLYPH_UNICODE] = 0xFFFF;
    ...
    repeat(_glyphCount)
    {
        switch(_glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE])
        {
            //Set up alternating single quote marks
            case ord("'"):
                _in_single_quote = !_in_single_quote;
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = __SCRIBBLE_DEVANAGARI_OFFSET + (_in_single_quote? ord("^") : ord("*"));
            break;
            
            //Set up alternating double quote marks
            case ord("\""):
                _in_double_quote = !_in_double_quote;
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = __SCRIBBLE_DEVANAGARI_OFFSET + (_in_double_quote? ord("ß") : ord("Þ"));
            break;
            
            //Split up nukta ligatures into their componant parts
            //TODO - Convert to hex and add comments
            case ord("ऩ"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("न");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ऱ"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("र");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("क़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("क");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ख़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("ख");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ग़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("ग");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ज़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("ज");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ड़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("ड");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("ढ़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("ढ");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("फ़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("फ");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
            
            case ord("य़"):
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = ord("य");
                __SCRIBBLE_PARSER_INSERT_NUKTA
            break;
        }
    ...
    {
        var _char = _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE];
        if (_char == ord("ि"))
        {
            var _j = _i - 1;
            while(_j >= 0)
            {
                var _prev_char = _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_UNICODE];
            ...
            ds_grid_set_grid_region(_temp_grid, _glyph_grid, _j, 0, _i-1, __SCRIBBLE_GEN_GLYPH_SIZE, 0, 0);
            
            //Then copy that back into the glyph grid, but one character forwards
            ds_grid_set_grid_region(_glyph_grid, _temp_grid, 0, 0, _i-1 - _j, __SCRIBBLE_GEN_GLYPH_SIZE, _j+1, 0);
            
            //Insert ि  (encoded in Krutidev as f) into its new position
            _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = __SCRIBBLE_DEVANAGARI_OFFSET + ord("f");
            _glyph_grid[# _j, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _j+1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
        }
    ...
    for(var _i = 0; _i < _glyphCount; ++_i)
    {
        ...
        if ((_glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] == ord("र")) && (_glyph_grid[# _i+1, __SCRIBBLE_GEN_GLYPH_UNICODE] == 0x094D)) //Ra followed by virama
        {
            var _newPosition = _i + 2;
            
            //If the character after the probable position for ra+virama is a matra, keep searching right
            var _charRight = _glyph_grid[# _newPosition+1, __SCRIBBLE_GEN_GLYPH_UNICODE];
            while(ds_map_exists(_krutidev_matra_lookup_map, _charRight))
            {
                _newPosition++;
                _charRight = _glyph_grid[# _newPosition+1, __SCRIBBLE_GEN_GLYPH_UNICODE];
            }
            ...
            ds_grid_set_grid_region(_temp_grid, _glyph_grid, _i+2, 0, _glyphCount-1 + 4, __SCRIBBLE_GEN_GLYPH_SIZE, _i+2, 0);
            ...
            ds_grid_set_grid_region(_glyph_grid, _temp_grid, _i+2, 0, _newPosition, __SCRIBBLE_GEN_GLYPH_SIZE, _i, 0);
            
            //Insert the new ra+virama combined character. Krutidev handles this as a single glyph (encoded as Z)
            _glyph_grid[# _i + _copyCount, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = __SCRIBBLE_DEVANAGARI_OFFSET + ord("Z");
            _glyph_grid[# _i + _copyCount, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _copyCount-1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
            
            //Second copy: Place the remainder of the glyphs after ra+virama
            ds_grid_set_grid_region(_glyph_grid, _temp_grid, _newPosition+1, 0, _glyphCount+3, __SCRIBBLE_GEN_GLYPH_SIZE, _i + _copyCount + 1, 0);
    ...
    var _oneChar   = 0x0000;
    var _twoChar   =              ((_glyph_grid[# 0, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 16);
    var _threeChar = _twoChar   | ((_glyph_grid[# 1, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 32);
    var _fourChar  = _threeChar | ((_glyph_grid[# 2, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 48);
    ...
    for(var _i = 0; _i < _glyphCount; ++_i;)
    {
        ...
        _fourChar  = _threeChar | ((_glyph_grid[# _i+3, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 48);
        ...
        if (_replacementArray != undefined)
        {
            ...
            if ((_foundLength == 1) && (_replacementLength == 1))
            {
                ...
                _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE] = __SCRIBBLE_DEVANAGARI_OFFSET + _replacementArray[0];
            }
            else
            {
                ...
                repeat(_copyCount)
                {
                    _glyph_grid[# _i + _j, __SCRIBBLE_GEN_GLYPH_UNICODE] = __SCRIBBLE_DEVANAGARI_OFFSET + _replacementArray[_j];
                    ++_j;
                }
                ...
                if (_foundLength > _replacementLength)
                {
                    ...
                    ds_grid_set_grid_region(_temp_grid, _glyph_grid, _copyStart, 0, _glyphCount, __SCRIBBLE_GEN_GLYPH_SIZE, 0, 0);
                    ds_grid_set_grid_region(_glyph_grid, _temp_grid, 0, 0, _copyLength, __SCRIBBLE_GEN_GLYPH_SIZE, _i + _copyCount, 0);
                }
                else if (_foundLength < _replacementLength)
                {
                    ...
                    ds_grid_set_grid_region(_temp_grid, _glyph_grid, _insertPos, 0, _glyphCount, __SCRIBBLE_GEN_GLYPH_SIZE, 0, 0);
                    ds_grid_set_grid_region(_glyph_grid, _temp_grid, 0, 0, _glyphCount - _insertPos, __SCRIBBLE_GEN_GLYPH_SIZE, _insertPos + (_replacementLength - _foundLength), 0);
                    
                    if (_replacementLength - _foundLength == 1)
                    {
                        //Adding one character
                        _glyph_grid[# _insertPos, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = __SCRIBBLE_DEVANAGARI_OFFSET + _replacementArray[_replacementLength-1];
                        _glyph_grid[# _insertPos, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _insertPos-1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
                    }
                    else if (_replacementLength - _foundLength == 2)
                    {
                        //Adding two characters
                        _glyph_grid[# _insertPos, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = __SCRIBBLE_DEVANAGARI_OFFSET + _replacementArray[_replacementLength-2];
                        _glyph_grid[# _insertPos, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _insertPos-1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
                        
                        _glyph_grid[# _insertPos+1, __SCRIBBLE_GEN_GLYPH_UNICODE      ] = __SCRIBBLE_DEVANAGARI_OFFSET + _replacementArray[_replacementLength-1];
                        _glyph_grid[# _insertPos+1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT] = _glyph_grid[# _insertPos-1, __SCRIBBLE_GEN_GLYPH_CONTROL_COUNT];
                    }
                    else
                    {
                ...
                _twoChar   =              ((_glyph_grid[# _i+1, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 16);
                _threeChar = _twoChar   | ((_glyph_grid[# _i+2, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 32);
                _fourChar  = _threeChar | ((_glyph_grid[# _i+3, __SCRIBBLE_GEN_GLYPH_UNICODE] & 0xFFFF) << 48);
            }
        }
    }
    ...
    repeat(_glyphCount)
    {
        ...
        var _found_glyph = _glyph_grid[# _i, __SCRIBBLE_GEN_GLYPH_UNICODE];
