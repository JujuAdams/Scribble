...
///      You should use ScribbleFastA() instead if you plan for the drawn text to persist for
...
function ScribbleDirect(_x, _y, _string, _colour = c_white, _alpha = 1, _hAlign = fa_left, _vAlign = fa_top, _font = undefined, _fontScale = 1)
{
