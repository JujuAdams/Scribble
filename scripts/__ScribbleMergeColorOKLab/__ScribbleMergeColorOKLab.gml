...
function __ScribbleMergeColorOKLab(_color0, _color1, _amount)
{
    static _struct0 = {};
    static _struct1 = {};
    static _struct2 = {};
    
    __ScribbleSRGBToOKLab(_color0, _struct0);
    __ScribbleSRGBToOKLab(_color1, _struct1);
    __ScribbleMergeOKLab(_struct0, _struct1, _amount, _struct2);
    return __ScribbleOKLabToSRGB(_struct2);
}

function __ScribbleMergeOKLab(_structA, _structB, _amount, _structOut = undefined)
{
    static _result = {
        l: 0,
        a: 0,
...
function __ScribbleSRGBToOKLab(_color, _struct = undefined)
{
    static _result = {
        l: 0,
        a: 0,
    ...
    var _linear = __ScribbleSRGBToLinear(_color);
    with(_linear)
    {
...
function __ScribbleOKLabToSRGB(_struct)
{
    with(_struct)
    {
    ...
    return __ScribbleLinearToSRGB(_struct);
}

function __ScribbleSRGBToLinear(_color, _struct = undefined)
{
    static _result = {
        r: 0,
        g: 0,
...
function __ScribbleLinearToSRGB(_struct)
{
    with(_struct)
    {
        if (r < 0.0031308)
