...
function ScribbleFastTest(_x, _y, _string, _colour = c_white, _alpha = 1, _hAlign = fa_left, _vAlign = fa_top, _font = undefined, _preScale = 1, _maxWidth = infinity, _maxHeight = infinity, _scaleToBox = false)
{
    ...
    else
    {
        ...
        {
            _struct = new __ScribbleClassFastTest(_string, _hAlign, _vAlign, _font, _preScale, _maxWidth, _maxHeight, _scaleToBox);
            _cache[$ _key] = _struct;
        }
...
function __ScribbleClassFastTest(_string, _hAlign, _vAlign, _font, _preScale, _maxWidth, _maxHeight, _scaleToBox) constructor
{
    ...
    __vertexBuilder = new __ScribbleClassVertexBuilder(__string, __hAlign, __vAlign, _font, __scale, __wrapWidth);
    ...
    {
        static _shdScribbleFast_u_vPositionAlphaScale = shader_get_uniform(__shdScribbleFast, "u_vPositionAlphaScale");
        static _shdScribbleFast_u_iColour = shader_get_uniform(__shdScribbleFast, "u_iColour");
        
        static _shdScribbleFastSDF_u_vPositionAlphaScale = shader_get_uniform(__shdScribbleFastSDF, "u_vPositionAlphaScale");
        static _shdScribbleFastSDF_u_iColour = shader_get_uniform(__shdScribbleFastSDF, "u_iColour");
        
        if (__fontSDFSpread == undefined)
        {
            shader_set(__shdScribbleFast);
        ...
        {
            shader_set(__shdScribbleFastSDF);
...
function __ScribbleClassVertexBuilder(_string, _hAlign, _vAlign, _font, _scale, _wrapWidth) constructor
{
