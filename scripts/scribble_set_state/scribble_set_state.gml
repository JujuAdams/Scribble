...
global.scribble_state_shadow_color     = argument0[SCRIBBLE_STATE.MSDF_SHADOW_COLOR    ];
global.scribble_state_shadow_alpha     = argument0[SCRIBBLE_STATE.MSDF_SHADOW_ALPHA    ];
global.scribble_state_shadow_x_offset  = argument0[SCRIBBLE_STATE.MSDF_SHADOW_X_OFFSET ];
global.scribble_state_shadow_y_offset  = argument0[SCRIBBLE_STATE.MSDF_SHADOW_Y_OFFSET ];
