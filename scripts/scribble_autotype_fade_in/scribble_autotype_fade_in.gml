...
function scribble_autotype_fade_in()
{
	...
	_occurrence_array[@ __SCRIBBLE_OCCURRENCE.FADE_IN     ] =  true;
	_occurrence_array[@ __SCRIBBLE_OCCURRENCE.SKIP        ] =  false;
    
    //Clear events tracking
    _occurrence_array[@ __SCRIBBLE_OCCURRENCE.EVENT_PREVIOUS     ] = _page_array[__SCRIBBLE_PAGE.START_EVENT] - 1;
    _occurrence_array[@ __SCRIBBLE_OCCURRENCE.EVENT_CHAR_PREVIOUS] = _page_array[__SCRIBBLE_PAGE.START_CHAR ] - 1;
    //Clear out the visited array too
    var _visited_array = _occurrence_array[__SCRIBBLE_OCCURRENCE.EVENT_VISITED_ARRAY];
    _occurrence_array[@ __SCRIBBLE_OCCURRENCE.EVENT_VISITED_ARRAY] = array_create(array_length(_visited_array), false);
}